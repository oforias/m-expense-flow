...
exports.enforceTrackerLimits = void 0;
const functions = require("firebase-functions");
const admin = require("firebase-admin");
exports.enforceTrackerLimits = functions.https.onCall(async (data, context) => {
...
function getCategoryType(categoryId) {
    ...
    if (wantCategories.includes(categoryId))
        return 'want';
    if (needCategories.includes(categoryId))
        return 'need';
    if (hybridCategories.includes(categoryId))
        return 'hybrid';
    // Default to hybrid for unknown categories
    return 'hybrid';
}
//# sourceMappingURL=enforceTrackerLimits.js.map