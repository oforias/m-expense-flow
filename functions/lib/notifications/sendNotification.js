...
exports.cleanupOldNotifications = exports.sendStreakRiskReminders = exports.sendStreakReminders = exports.sendNotification = void 0;
...
exports.sendNotification = functions.firestore
    ...
    try {
        ...
        const { userId, fcmToken, title, body, data, type } = notificationData;
        if (!fcmToken) {
        ...
        const message = {
            ...
            data: Object.assign(Object.assign({}, data), { type: type, notificationId: context.params.notificationId }),
            android: {
                notification: {
 ...
 */
async function updateUserNotificationStats(userId, type) {
    try {
 ...
 */
exports.sendStreakRiskReminders = functions.pubsub
