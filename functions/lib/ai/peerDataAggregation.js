...
exports.triggerPeerDataAggregation = exports.aggregatePeerData = void 0;
 ...
 */
exports.aggregatePeerData = functions.pubsub
    ...
    try {
        ...
        Object.entries(categoryData).forEach(([category, data]) => {
            ...
            const avgPercentage = data.percentages.reduce((sum, val) => sum + val, 0) / data.percentages.length;
 ...
 */
exports.triggerPeerDataAggregation = functions.https.onCall(async (data, context) => {
    // Verify the request is from an authenticated admin
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Must be authenticated to trigger aggregation');
    }
    const db = admin.firestore();
    try {
...
//# sourceMappingURL=peerDataAggregation.js.map