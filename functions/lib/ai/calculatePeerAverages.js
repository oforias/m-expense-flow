...
exports.triggerPeerAveragesCalculation = exports.calculatePeerAverages = void 0;
const admin = require("firebase-admin");
const functions = require("firebase-functions");
// Scheduled function to calculate peer averages daily
exports.calculatePeerAverages = functions.pubsub
...
exports.triggerPeerAveragesCalculation = functions.https.onCall(async (data, context) => {
...
async function calculatePeerAveragesForPeriod(db, period) {
    ...
    categoryData.forEach((data, category) => {
        ...
        batch.set(docRef, Object.assign(Object.assign({}, peerData), { lastUpdated: admin.firestore.FieldValue.serverTimestamp(), period }));
    });
    await batch.commit();
...
//# sourceMappingURL=calculatePeerAverages.js.map