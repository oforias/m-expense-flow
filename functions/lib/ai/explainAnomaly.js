 ...
 */
exports.explainAnomaly = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        return Object.assign({ success: true, amount,
...
//# sourceMappingURL=explainAnomaly.js.map