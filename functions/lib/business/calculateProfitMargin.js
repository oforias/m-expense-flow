...
exports.calculateProfitMargin = void 0;
const functions = require("firebase-functions");
const admin = require("firebase-admin");
const db = admin.firestore();
const calculateProfitMargin = async (data, context) => {
...
function calculateDateRange(period) {
    ...
    switch (period.toLowerCase()) {
        ...
        default:
            throw new functions.https.HttpsError('invalid-argument', 'Invalid period. Valid periods are: weekly, monthly, quarterly, yearly, all_time');
    }
}
//# sourceMappingURL=calculateProfitMargin.js.map