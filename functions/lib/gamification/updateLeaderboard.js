...
exports.resetMonthlyLeaderboard = exports.resetLeaderboards = exports.calculateRankings = exports.updateLeaderboard = void 0;
const admin = require("firebase-admin");
const functions = require("firebase-functions");
const updateLeaderboard = async (data, context) => {
    if (!context.auth) {
    ...
    try {
        ...
        await (0, exports.calculateRankings)(data.period);
        return {
            success: true,
...
const calculateRankings = async (period) => {
    const db = admin.firestore();
    try {
...
exports.resetLeaderboards = functions.pubsub.schedule('0 0 * * 0').onRun(async (context) => {
    const db = admin.firestore();
    try {
...
exports.resetMonthlyLeaderboard = functions.pubsub.schedule('0 0 1 * *').onRun(async (context) => {
    const db = admin.firestore();
    try {
...
function generateAnonymousUsername(name, userId) {
    const adjectives = [
